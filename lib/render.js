...
module.exports = (srcPath, pages) => {
  const template = fs.readFileSync(path.join(srcPath, "template.ejs"), "utf8");
  const indexTemplate = fs.readFileSync(path.join(srcPath, "index.ejs"), "utf8");
